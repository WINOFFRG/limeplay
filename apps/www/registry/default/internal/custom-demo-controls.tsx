...
export function CustomDemoControls({ children }: React.PropsWithChildren) {
  return (
    <section className="animate-in fade-in-100 to-primary relative mt-10 flex w-full flex-row bg-gradient-to-br from-gray-100 px-8 py-3 transition-all duration-500 ease-in-out dark:from-neutral-900 dark:to-neutral-950">
      <div
