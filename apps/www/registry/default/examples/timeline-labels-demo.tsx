    ...
    <div className="my-4 flex h-fit w-full flex-col gap-4 rounded-md border p-4 pt-6">
      ...
      <div className="grid grid-cols-2 gap-4 pt-2">
        <div className="flex flex-col gap-1">
          ...
          <Elapsed className="font-medium text-sm" />
        </div>
        <div className="flex flex-col gap-1">
          <span className="text-muted-foreground text-xs">Remaining:</span>
          <Remaining className="font-medium text-sm" />
        </div>
        <div className="flex flex-col gap-1">
          <span className="text-muted-foreground text-xs">Duration:</span>
          <Duration className="font-medium text-sm" />
        </div>
        <div className="flex flex-col gap-1">
          <span className="text-muted-foreground text-xs">Hover Time:</span>
          <HoverTime className="font-medium text-sm" />
        </div>
      </div>
    </div>
  );
