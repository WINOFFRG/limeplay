...
### Shaka Player
Our foundational streaming engine used across all components. We selected Shaka Player after extensive evaluation for its robust streaming capabilities and performance—[learn more about this decision](./what-is-limeplay.mdx#why-choose-limeplay).
