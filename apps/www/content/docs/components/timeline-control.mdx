...
export function TimelineSliderControl() {
  return (
    <div className="relative w-full grow">
      <TimelineSlider.Root className="h-1 rounded-full hit-area hit-area-x-[2px] hit-area-y-[14px]">
...
<AutoTypeTable
  path="./registry/default/ui/timeline-control.tsx"
  name="TimelineBufferedPropsDocs"
/>
