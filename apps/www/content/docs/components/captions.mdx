...
<Callout>
  Requires [`captionsFeature`](/docs/hooks/use-captions) registered in your
...
<AutoTypeTable
  path="./registry/default/ui/captions.tsx"
  name="CaptionsContainerPropsDocs"
/>
