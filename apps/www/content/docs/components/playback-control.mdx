...
```npm
npx shadcn add https://limeplay.winoffrg.dev/r/playback-control.json
```
</Step>
...
import { useMediaStates } from "@/hooks/limeplay/use-media-state" // [!code ++]
...
import {
  ...
  MediaStateStore,
} from "@/hooks/limeplay/use-media-state" // [!code ++]
import {
