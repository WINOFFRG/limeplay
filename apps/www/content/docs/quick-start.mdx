---
title: Quick Start
description: Install a complete Limeplay React video player block with the shadcn CLI and start playing adaptive media.
index: true
---

<Callout title="For Agents" type="idea">
  Copy the [this](/docs/ai-agents) link and paste it into your coding agent.
</Callout>
