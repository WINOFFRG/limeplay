---
title: Concepts
description: Understand Limeplay's feature model, isolated media stores, typed events, component hierarchy, and source loading architecture.
index: true
---
...
<Mermaid
  chart="
flowchart TD
  Provider[MediaProvider<br/>Store, events, feature setup] --> Root[RootContainer<br/>Root state attributes];
