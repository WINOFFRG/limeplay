...
export function ScrollIndicator() {
  ...
  return (
    <motion.div
      className={
        "-translate-x-1/2 pointer-events-none fixed bottom-8 left-1/2 z-20 hidden transform md:block"
      }
      style={{ opacity, y }}
    >
        ...
        >
          <div className="relative h-10 w-6 rounded-full border-2 border-slate-400/60">
            <motion.div
              ...
              className="-translate-x-1/2 absolute top-2 left-1/2 h-3 w-1 transform rounded-full bg-slate-500/80"
              transition={{
                duration: 1.5,
