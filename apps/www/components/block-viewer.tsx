...
function BlockViewerToolbar() {
  ...
  return (
    <div className="hidden w-full items-center gap-2 pl-2 md:pr-6 lg:flex">
      ...
      <a
        href={`#${item.name}`}
        className="flex-1 text-center text-sm font-medium underline-offset-2 hover:underline md:flex-auto md:text-left text-primary-foreground"
      >
...
function BlockViewerCode() {
  ...
  return (
    <div className="mr-[14px] flex overflow-hidden rounded-xl border group-data-[view=preview]/block-view-wrapper:hidden md:h-(--height)">
      <div className="w-auto max-w-96 overflow-auto">
        <BlockViewerFileTree />
      </div>
      ...
      <CodeBlock
        ...
        keepBackground
        data-line-numbers
        className="my-0 rounded-none w-full"
        viewportProps={{
          className: "no-scrollbar h-full max-h-fit [&_*]:text-red-500",
        }}
      >
...
export function BlockViewerFileTree() {
  ...
  return (
    <SidebarProvider className="flex !min-h-full flex-col border-r border-primary-foreground">
