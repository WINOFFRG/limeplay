...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      className={cn(
        "z-51 flex h-6 w-full cursor-default items-center justify-center border bg-popover text-center text-base data-[direction=up]:rounded-t-md data-[direction=down]:rounded-b-md data-[direction=down]:border-t-0 data-[direction=up]:border-b-0",
