...
export function VideoBackground() {
  ...
  return (
    <motion.div
      animate={{ opacity: 1 }}
      className="pointer-events-none fixed inset-0 z-0 transform-gpu select-none overflow-hidden will-change-transform"
      initial={{ opacity: 0 }}
      style={{ opacity, scale }}
      transition={{
        duration: 1,
    ...
    >
      ...
      >
        <Image
          alt="Tree shadow"
          className={
            "size-full object-cover opacity-50 mix-blend-multiply blur-xs sm:scale-120 sm:object-fill"
          }
          priority
          quality={75}
          src={ShadowOverlay28}
