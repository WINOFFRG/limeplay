  ...
  return (
    <>
      ...
      <Tooltip>
        ...
        {/* <TooltipContent className="rounded-lg px-2 py-1.5" side="right">
          Toggle{" "}
          <KbdGroup>
            <Kbd className="rounded-md text-xs">Cmd</Kbd>
            <Kbd className="rounded-md text-xs">B</Kbd>
          </KbdGroup>
        </TooltipContent> */}
      </Tooltip>
      <motion.aside
      ...
      >
        <div
          className={`
            flex h-full w-full flex-col rounded-lg border border-sidebar-border bg-sidebar pt-14 text-sidebar-foreground
            shadow-[0_18px_50px_rgba(15,23,42,0.08)]
          `}
        >
          {/* <SidebarHeader className="gap-1 px-3 pt-6 pb-2 pl-14">
  ...
  return (
    <motion.span
      animate={{
        ...
        x: isExpanded && !isMobile ? "-20px" : "-14px",
        y: isExpanded && !isMobile ? "-3px" : "2px",
      }}
      className="fixed top-0 left-10 z-21 mt-[35.5px] flex items-center justify-center"
      initial={false}
    ...
    >
      <TooltipTrigger asChild>
        <button
          className={`
            flex size-full items-center justify-center rounded-xl text-foreground/60
            active:scale-[0.98]
          `}
          type="button"
        >
